## moveit_setup_assistant (indigo) - 0.7.2-0

The packages in the `moveit_setup_assistant` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo moveit_setup_assistant` on `Sat, 25 Jun 2016 01:31:20 -0000`
...
## moveit_setup_assistant (jade) - 0.7.1-0

The packages in the `moveit_setup_assistant` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade moveit_setup_assistant` on `Fri, 24 Jun 2016 22:25:47 -0000`
...
## moveit_setup_assistant (indigo) - 0.7.0-0

The packages in the `moveit_setup_assistant` repository were released into the `indigo` distro by running `/usr/bin/bloom-release moveit_setup_assistant --track indigo --rosdistro indigo` on `Sat, 30 Jan 2016 21:14:41 -0000`
